            ...
            try {
                ...
                if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (isNewerVersion(cleanedTag, currentVersion) && cleanedTag != skippedVersion) {
                        // Use the canonical releases page URL regardless of what GitHub returns
                        val releasesUrl = "https://github.com/MukulBolt9/xz/releases/latest"
                        _updateAvailable.value = UpdateInfo(cleanedTag, releasesUrl)
                    }
                }
            } catch (e: Exception) {
