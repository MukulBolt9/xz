...
class HealthConnectRepository(private val context: Context) {
    ...
    // SDK status per the guide:
    // SDK_AVAILABLE                            → ready to use
    // SDK_UNAVAILABLE_PROVIDER_MIN_VERSION_NOT_MET → needs Play Store update
    // SDK_UNAVAILABLE                          → not supported on this device
    ...
    // Exact permission set per guide
