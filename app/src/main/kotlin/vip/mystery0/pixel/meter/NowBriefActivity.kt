    ...
    val hcPermLauncher = rememberLauncherForActivityResult(
        ...
        if (grantedPermissions.isNotEmpty()) {
            coroutineScope.launch {
                ...
                hcSnap?.sleep?.night?.let { night ->
                    if (night.actualMinutes > 0) estimatedSleepH = night.actualMinutes / 60f
                }
            }
        }
    }
                ...
                Column(Modifier.padding(18.dp), verticalArrangement = Arrangement.spacedBy(14.dp)) {
                    ...
                    val metrics = listOf(
                        ...
                        HcMetric("\uD83D\uDCA8", "SpO\u2082",
                            ...
                            snap?.spO2 != null),
                        HcMetric("\uD83D\uDECF\uFE0F", "Sleep",
                            if (snap?.sleep != null) "${"%.1f".format(snap.sleep!!.totalActualSleepMinutes / 60f)}h" else "--",
                            snap?.sleep != null),
                        HcMetric("\uD83D\uDD25", "Calories",
