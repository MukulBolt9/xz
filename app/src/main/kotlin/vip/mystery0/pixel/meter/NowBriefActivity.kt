...
fun LiquidGlassCard(
    ...
    // Low-alpha surface — just a tint so blur+vibrancy dominate.
    // Dark: white at 6% (adds a frosted haze over the dark aurora blur).
    // Light: white at 40% (pulls brightness up against light bg).
    val containerColor = if (isDark) Color.White.copy(alpha = 0.06f)
